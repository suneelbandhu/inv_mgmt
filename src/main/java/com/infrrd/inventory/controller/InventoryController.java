...
public class InventoryController {
	...
	public Map<String, Object> createInventory(@RequestBody InventoryData request)
			throws InventoryAlreadyExistsException {
		try {
			LOGGER.info("createInventory request ", request);
	...
	/**
	 * API to get the details of an inventory if exists(i.e. exists with status as true)
	 * @param inventoyId
	...
	public InventoryData getInventory(@PathVariable String inventoyId) throws InventoryNotFoundException {
		try {
			LOGGER.info("getInventory details for inventory id ", inventoyId);
	...
	public Map<String, Object> deleteInventory(@PathVariable String inventoyId) throws InventoryNotFoundException {
		try {
			LOGGER.info("delete inventory details for inventory id ", inventoyId);
	...
	/**
	 * API to list the given inventory created/deleted on between the given range
	 * date
	 * 
	 * @param fromDate
	 * @param toDate
	...
	public List<InventoryData> listInventory(@PathVariable Date fromDate, @PathVariable Date toDate) throws Exception {
		try {
			LOGGER.info("listInventory details between fromDate ", fromDate , " and toDate" , toDate);
